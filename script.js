...
//   Use the filter method to get all the big spenders (order over 9,000 dollars) in the main array into a new one.

// Array to contain all the big spenders
const bigSpenders = businesses.filter(business => {
    let bigSpender = false
    let purchases = business.orders
